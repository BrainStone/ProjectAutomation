...
public class CMDCreate implements CommandExecutor {
	...
	private void invalidArgs(CommandSource src) {
		...
		list.add(Text.builder().color(TextColors.YELLOW).onHover(TextActions.showText(Text.of("Click command for more information "))).append(Text.of(" /auto create <name> <command> <time> [repeat]\n")).build());

		if (src.hasPermission("pja.cmd.auto.create.button")) {
			list.add(Text.builder().color(TextColors.GREEN).onHover(TextActions.showText(Text.of("Click command for more information "))).onClick(TextActions.runCommand("/auto help button")).append(Text.of(" /auto create button")).build());
		}
		if (src.hasPermission("pja.cmd.auto.create.door")) {
			list.add(Text.builder().color(TextColors.GREEN).onHover(TextActions.showText(Text.of("Click command for more information "))).onClick(TextActions.runCommand("/auto help door")).append(Text.of(" /auto create door")).build());
		}
		if (src.hasPermission("pja.cmd.auto.create.lever")) {
			list.add(Text.builder().color(TextColors.GREEN).onHover(TextActions.showText(Text.of("Click command for more information "))).onClick(TextActions.runCommand("/auto help lever")).append(Text.of(" /auto create lever")).build());
		}
		if (src.hasPermission("pja.cmd.auto.create.plate")) {
			list.add(Text.builder().color(TextColors.GREEN).onHover(TextActions.showText(Text.of("Click command for more information "))).onClick(TextActions.runCommand("/auto help plate")).append(Text.of(" /auto create plate")).build());
		}
		if (src.hasPermission("pja.cmd.auto.create.sign")) {
			list.add(Text.builder().color(TextColors.GREEN).onHover(TextActions.showText(Text.of("Click command for more information "))).onClick(TextActions.runCommand("/auto help sign")).append(Text.of(" /auto create sign")).build());
		}
