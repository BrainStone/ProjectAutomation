...
public class DoorListener {
	...
	public void onChangeBlockEvent(ChangeBlockEvent.Modify event, @First Player player) {
		for (Transaction<BlockSnapshot> transaction : event.getTransactions()) {
			...
			if (!type.equals(BlockTypes.ACACIA_DOOR) && !type.equals(BlockTypes.BIRCH_DOOR) && !type.equals(BlockTypes.DARK_OAK_DOOR) && !type.equals(BlockTypes.IRON_DOOR) && !type.equals(BlockTypes.JUNGLE_DOOR) && !type.equals(BlockTypes.SPRUCE_DOOR) && !type.equals(BlockTypes.TRAPDOOR) && !type.equals(BlockTypes.WOODEN_DOOR)) {
				return;
			}
